...
export const destinations: Destination[] = [
    ...
    nodes: [
      {
        ...
        panoSrc: "/panoramas/tawang-entrance.png",
        links: { forward: "courtyard" },
      },
      {
        id: "courtyard",
        label: "Inner courtyard",
        panoSrc: "/panoramas/tawang-courtyard.png",
        links: { back: "entrance", forward: "valley" },
      },
      {
        id: "valley",
        label: "Valley overlook",
        panoSrc: "/panoramas/tawang-valley.png",
  ...
  },
  {
    ...
    lng: 88.6122,
    heading: 45,
    panoSrc: "/panoramas/gangtok-mg-marg.png",
  },
  {
    slug: "nagaland",
    name: "Nagaland",
    ...
    nodes: [
      {
        id: "plaza",
        label: "Village plaza",
        panoSrc: "/panoramas/nagaland-plaza.png",
        links: { forward: "morung", right: "trail" },
      },
      {
        id: "morung",
        label: "Morung front",
        panoSrc: "/panoramas/nagaland-morung.png",
        links: { back: "plaza" },
      },
      {
        id: "trail",
        label: "Hill trail edge",
        panoSrc: "/panoramas/nagaland-trail.png",
        links: { left: "plaza" },
      },
    ],
    startNodeId: "plaza",
    ...
    nodes: [
      {
        id: "track",
        label: "Jeep track",
        panoSrc: "/panoramas/kaziranga-track.png",
        links: { forward: "tower" },
      },
      {
        id: "tower",
        label: "Watchtower view",
        panoSrc: "/panoramas/kaziranga-tower.png",
        links: { back: "track", left: "grass" },
      },
      {
        id: "grass",
        label: "Grassland edge",
        panoSrc: "/panoramas/kaziranga-grass.png",
        links: { right: "tower" },
      },
    ],
    startNodeId: "track",
  ...
  },
  {
    ...
    lookSource: "own",
    panoSrc: "/panoramas/mizoram-ridge.png",
  },
  {
    slug: "tripura",
    name: "Tripura",
    ...
    lookSource: "own",
    panoSrc: "/panoramas/tripura-palace.png",
  },
];
