...
export const PLACE_CLIPS: PlaceClip[] = [
  {
    ...
    poster: U("photo-1520962880247-cfaf541c8724"),
    likes: 12840,
    rating: 4.9,
  ...
  },
  {
    ...
    poster: U("photo-1516815231560-8f41ec531527"),
    likes: 22100,
    rating: 4.8,
...
export const PUBLISHED_ITINERARIES: PublishedItinerary[] = [
  {
    ...
    likes: 842,
    reviews: 56,
    cover: U("photo-1520962880247-cfaf541c8724"),
    photos: [U("photo-1520962880247-cfaf541c8724"), U("photo-1439066615861-d1af74d74000"), U("photo-1441974231531-c6227db76b6e")],
  ...
  },
  {
    ...
    likes: 2104,
    reviews: 188,
    cover: U("photo-1516815231560-8f41ec531527"),
    photos: [U("photo-1516815231560-8f41ec531527"), U("photo-1520962880247-cfaf541c8724")],
...
export const CREATOR_PLANS: CreatorPlan[] = [
  ...
  },
  {
    ...
    cover: U("photo-1520962880247-cfaf541c8724"),
    photos: [U("photo-1520962880247-cfaf541c8724")],
    videos: [SAMPLE_VIDEOS[0]],
    days: 3,
    priceFrom: 12400,
    likes: 980,
...
export const HOST_HOMES: HostHome[] = [
  {
    ...
    rating: 4.8,
    reviews: 312,
    photos: [U("photo-1587061949409-02df41d5e562"), U("photo-1520962880247-cfaf541c8724")],
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 201,
    photos: [U("photo-1516815231560-8f41ec531527")],
